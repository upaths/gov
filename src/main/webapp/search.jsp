...
<table width="1004" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<td valign="top"><table width="100%" border="0" cellpadding="0"
				cellspacing="0" class="kk2">
				<tr>
					<td valign="top"><table width="100%" border="1"
							cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="kk">
							<tr>
								<td width="180" height="35" align="center" valign="middle"
									background="images/nzcms.2011_48.gif"><strong
									class="white14">搜索信息</strong></td>
								<td width="524" align="right" valign="middle"
									background="images/left_bg1.jpg">&nbsp;</td>
							</tr>
							<tr>
								<td colspan="2" align="center" valign="top"><c:forEach
										items="${list }" var="item">
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td height="25"><table width="100%" border="0"
														align="center" cellpadding="0" cellspacing="0" class="dx">
														<tr>
															<td width="30" height="35" align="center"><img
																src="images/nzshu.gif" alt="图标"></td>
															<td align="left"><a
																href="showNews.action?article.id=${item.id }"
																target="_blank"> ${item.bt }</a></td>
															<td width="100" align="left" class="gray">浏览：${item.ydcs
																}次</td>
															<td width="130" align="center" class="gray">发稿：${item.lrrq
																}</td>
														</tr>
													</table></td>
											</tr>
