<#include "top.ftl">
    <div class="content">
        <div class="content-topic">
            ...
            <@articleListTag posid=1 size=1; list>
        ...
        <div class="col-left">
            <div class="module-nav">
                ...
                <div class="module-list">
                    <ul>
                    <@articleListTag catid=70 size=5; list>
                        <#list list as article>
                            <li>
                                <i></i>
                                <a href="<@c.url value="${contextPath}/content.action?id=${article.id}"/>" target="_blank">
            ...
            <div class="module-nav module-tab">
                ...
                <div class="module-list">
                    <ul>
                    <@articleListTag catid=64 size=5; list>
                        <#list list as article>
                            <li>
                                <i></i>
                                <a href="<@c.url value="${contextPath}/content.action?id=${article.id}"/>" target="_blank">
                    ...
                    <ul>
                    <@articleListTag catid=69 size=5; list>
                        <#list list as article>
                            <li>
                                <i></i>
                                <a href="<@c.url value="${contextPath}/content.action?id=${article.id}"/>" target="_blank">
        ...
        <div class="col-right">
            ...
            <@categoryTag id=71; cat>
                <a href="<@c.url value="${contextPath}/list.action?id=${cat.id}&page=1"/>" target="_blank">
                    <img src="pic/baoguang.jpg" width="480" height="125"/>
                </a>
            </@categoryTag>
            </div>
            <div class="module-report">
                ...
                <@categoryTag id=95; cat>
                    <li><a href="http://${cat.url}" target="_blank">
            ...
            <div class="module-nav">
                ...
                <div class="module-hd">
                    ...
                    <@categoryTag id=76; cat>
                        <li>
                            <a href="<@c.url value="${contextPath}/list.action?id=${cat.id}&page=1"/>" target="_blank">
                                <i class="interactive"></i>${cat.name}
                            </a>
                        </li>
                    </@categoryTag>
                ...
                <div class="module-list">
                    <ul>
                    <@articleListTag catid=74 size=5; list>
                        <#list list as article>
                            <li>
                                <i></i>
                                <a href="<@c.url value="${contextPath}/content.action?id=${article.id}"/>" target="_blank">
        ...
        <div class="col-right">
            <div class="module-nav">
                ...
                <@categoryTag id=79; cat>
                    <a href="http://${cat.url}" target="_blank"><img src="pic/pingtai.jpg" width="480" height="75"/></a>
                </@categoryTag>
                </div>
                <div class="module-graphic-02">
                    <div class="module-graphic-03" style="margin-right:10px">
                    <@categoryTag id=80; cat>
                        <a href="<@c.url value="${contextPath}/list.action?id=${cat.id}&page=1"/>" target="_blank"><img src="pic/fangzheng.jpg" width="235" height="70"/></a>
                    </@categoryTag>
                    </div>
                    <div class="module-graphic-03">
                    <@categoryTag id=81; cat>
                        <a href="<@c.url value="${contextPath}/list.action?id=${cat.id}&page=1"/>" target="_blank"><img src="pic/qingfeng.jpg" width="235" height="70"/></a>
                    </@categoryTag>
                    </div>
                </div>
                <div class="module-graphic-02">
                <@categoryTag id=82; cat>
                    <a href="<@c.url value="${contextPath}/list.action?id=${cat.id}&page=1"/>" target="_blank"><img src="pic/dengji.jpg" width="480" height="75"/></a>
                </@categoryTag>
                </div>
            </div>
        </div>
        ...
        <div class="module-scroll">
            ...
            <div class="module-scroll-nav">
                <ul>
                <@articleListTag catid=84 size=10; list>
                    <#list list as article>
                        <li>
                            <a href="<@c.url value="${contextPath}/content.action?id=${article.id}"/>" target="_blank">
