...
<head>
    ...
    <script src="${contextPath}/easyui/jquery-1.8.0.min.js" type="text/javascript"></script>
    <script src="${contextPath}/script/jquery.SuperSlide.js" type="text/javascript"></script>
...
<body <#if config.preventCopy?? && config.preventCopy>onselectstart="return false" oncut="return false;" oncopy="return false;" onpaste="return false"</#if>>
</@configTag>
