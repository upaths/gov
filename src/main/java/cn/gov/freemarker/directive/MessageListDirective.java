 ...
 */
public class MessageListDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        List<Message> messageList = messageService.queryDisplayMessage(sort, page, size);
        ...
        if (body != null) {
            ...
            if (loopVars.length > 0) {
                // 数据
                loopVars[0] = ObjectWrapper.DEFAULT_WRAPPER.wrap(messageList);
